...
namespace Kinetix.Data.SqlClient
{
    ...
    public sealed class SqlServerDataReader : IDataReader
    {
        ...
        internal SqlServerDataReader(IDataReader dataReader, QueryParameter queryParameter)
        {
        ...
        public object this[int index]
        {
            get
            {
                var val = _innerDataReader[index];
                return DBNull.Value.Equals(val) ? null : val;
            }
        }
        ...
        public bool Read()
        {
            if (_queryParameter != null)
            {
                ...
                var hasData = _innerDataReader.Read();
                if (hasData)
                {
                    ++_readIndex;
                    return true;
        ...
        {
            return IsDBNull(index) ? null : (bool?)ReadBoolean(index);
        }
