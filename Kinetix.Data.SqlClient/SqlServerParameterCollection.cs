...
namespace Kinetix.Data.SqlClient
{
    ...
    public sealed class SqlServerParameterCollection : IDataParameterCollection, IList<SqlServerParameter>
    {
        ...
        /// Indique si la collection est en lecture seule.
        /// </summary>
        bool ICollection<SqlServerParameter>.IsReadOnly => _innerCollection.IsReadOnly;
        ...
        public SqlServerParameter this[int index]
        {
            ...
            set
            {
                _list[index] = value ?? throw new ArgumentNullException("value");
        ...
        {
            get => this[index];
            set => this[index] = (SqlServerParameter)value;
        }
        ...
        object IDataParameterCollection.this[string parameterName]
        {
            ...
            set => this[parameterName] = (SqlServerParameter)value;
        }
            ...
            where T : new()
        {
            ...
            var parameter = new SqlServerParameter(_innerCommand.CreateParameter())
            {
        ...
        {
            var param = _innerCommand.CreateParameter();
            ...
            var p = new SqlServerParameter(param);
            _list.Add(p);
            return p;
        }
        ...
        public SqlServerParameter AddBeanCollectionProperties<T>(ICollection<T> collection)
            where T : class, new()
        {
            var parameter = new SqlServerParameterBeanCollection<T>(null, collection, false).CreateParameter(_innerCommand);
            _list.Add(parameter);
            return parameter;
        }
        ...
        {
            return IndexOf((SqlServerParameter)value);
        }
        ...
        {
            Insert(index, (SqlServerParameter)value);
        }
        ...
        {
            Remove((SqlServerParameter)value);
        }
