...
namespace Kinetix.ComponentModel.ListFactory
{
    /// <summary>
    ...
    public abstract class AbstractListFactory
    {
        ...
        /// </summary>
        public ReadOnlyCollection<TableInit> Items => new ReadOnlyCollection<TableInit>(_mapInitialisation.Keys.Select(itemKey => _mapInitialisation[itemKey]).ToList());
