...
namespace Kinetix.Search.Test.SearchBrokerTest {
    ...
    /// </summary>
    [TestClass]
    public class AdvancedCountTest : AbstractSearchTest {
        ...
        private static void CheckFacets(long expected, FacetListInput facetsInput, string query = null) {
            ...
            SearchManager searchManager = GetServiceProvider().GetService<SearchManager>();
            var broker = searchManager.GetBroker<PersonneDocument>();
