...
namespace Kinetix.Caching.Test {
    ...
    /// </summary>
    [TestFixture]
    public class CacheTest : DIBaseTest {
        ...
        public void CacheMinimumThreadIntervalTest() {
            ...
            {
                CacheConfigItem cci = new CacheConfigItem() { DiskExpiryThreadIntervalSeconds = 0 };
        ...
        public void CacheMinimumDiskBufferTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { DiskSpoolBufferSizeMB = 0 };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
        ...
        public void CacheWarnDiskOnlyTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { MaxElementsInMemory = 0 };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
        ...
        public void DefaultDiskStorePathTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { DiskStorePath = null };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
        ...
        public void DiskStorePathTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { DiskStorePath = "/" };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
        ...
        public void CacheMaxElementsInMemoryTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { MaxElementsInMemory = 1 };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
        ...
        public void CacheEternalTest() {
            ...
            serviceCollection.Configure<CacheConfig>(cc =>
            {
                CacheConfigItem cci = new CacheConfigItem() { IsEternal = true };
                cc.Caches.Add("CacheDefaultConfiguration", cci);
            });
            BuildServiceProvider(serviceCollection);
            var serviceProvider = GetServiceProvider();
